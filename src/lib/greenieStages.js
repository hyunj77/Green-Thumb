// '그린이' 화분 성장 단계(5단계)와 기분 상태(3종) 계산.
// 기존 레벨/경험치(1~1000) 시스템은 그대로 두고, 화면에 보여줄 성장 단계로만 재해석한다.
export const STAGES = [
  { key: 'seed', label: '씨앗', minLevel: 1, maxLevel: 1 },
  { key: 'sprout', label: '새싹', minLevel: 2, maxLevel: 50 },
  { key: 'leaves', label: '잎사귀', minLevel: 51, maxLevel: 200 },
  { key: 'growth', label: '성장', minLevel: 201, maxLevel: 500 },
  { key: 'bloom', label: '개화', minLevel: 501, maxLevel: 1000 },
]
