export const PLANT_SPECIES = [
  ...
  { name: '스투키', emoji: '🌵', type: '다육식물', difficulty: '매우 쉬움', watering: '2~3주에 한 번', wateringDays: 18, light: '강한 빛 선호', petSafe: false },
  { name: '필레아', emoji: '🍀', type: '다육식물', difficulty: '쉬움', watering: '흙 표면이 마르면', wateringDays: 5, light: '밝은 간접광', petSafe: true },
...
export const PLANT_TYPES = ['관엽식물', '다육식물', '나무', '공기정화']
